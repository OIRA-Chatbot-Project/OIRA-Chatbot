export const SUGGESTED_QUESTION_GROUPS = {
  ...
  requirements: [
    ...
    'Are Math courses required for Computer Engineering?',
    'What general education or core requirements should I keep in mind when planning courses for ANOP major?',
  ],
  course_specific: [
